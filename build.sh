...
cmake .. -DCMAKE_BUILD_TYPE=Debug -DVCPKG_TARGET_TRIPLET=x64-linux -DOPENSSL_INCLUDE_DIR=/usr/include/openssl -DOPENSSL_SSL_LIBRARY=/usr/lib/openssl/libssl.so -DOPENSSL_CRYPTO_LIBRARY=/usr/lib/openssl/libcrypto.so 
