...
private:
  ...
  //  boost::optional<http::request_parser<request_body_t,
  //  std::allocator<char>>>
  //      parser_;
  http::request_parser<request_body_t> parser_;
  ...
  //  boost::optional<http::response<http::string_body,
  ...
  //  boost::optional<http::response_serializer<
  //      http::file_body, http::basic_fields<std::allocator<char>>>>
  //      file_serializer_;
  ...
  void send_post(beast::string_view target) {
    std::cout << "send_post" << std::endl;
    ...
    string_response_.keep_alive(parser_.keep_alive());
    string_response_.set(http::field::server, "Beast");
    string_response_.set(http::field::content_type, "text/plain");

    string_response_.body() = target.data();

    string_response_.prepare_payload();

    http::async_write(socket_, string_response_,
                      [this](beast::error_code ec, std::size_t) {
  ...
  void send_file(beast::string_view target) {
    ...
    */
    ...
    http::async_write(socket_, file_response_,
                      [this](beast::error_code ec, std::size_t) {
                        socket_.shutdown(tcp::socket::shutdown_send, ec);
                        // file_serializer_.reset();
                        // file_response_.reset();
