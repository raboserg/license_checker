...
public:
  ...
  void logout();
  void get_file_list();
  void get_file(const char *file_name, const char *path);
...
private:
  ...
  void create_socket(int &sock, const char *server_ip,
                     const unsigned short server_port);
  void parse_PASV_response(const std::string &str_rsp,
                           std::string &str_server_ip,
                           unsigned short &server_port);
  void close_socket(int sock);
  void receive_all(int sock, const char *file_name, const char *path);
